...
public record OrderReadModel(long Id, string OrderStatus, PaymentReadModel Payment, DeliveryAddressReadModel DeliveryAddress, List<OrderLineReadModel> OrderLines)
{
